...
class Defaults
{
    ...
    */
    ...
    let defaultPresets:[[String: AnyObject]] = [[
    ...
    */
    ...
    var presets: [[String: AnyObject]]
    {
        ...
        get
        {
            let presetsList = getObjectForKey("presets")
            return (presetsList ?? defaultPresets) as! [[String: AnyObject]]
        }
    }
    ...
    var colorLists: [[NSColor]]
    {
        set(newColorLists)
        {
            presets[presetIndex]["colors"] = colorListsToStringList(newColorLists)
        }
        get
        {
            return stringListToColorLists(presets[presetIndex]["colors"] as! [String])
        }
    }
    
    func colorListsToStringList(colorLists: [[NSColor]]) -> [String]
    {
    ...
    func stringListToColorLists(stringLists: [String]) -> [[NSColor]]
    {
        var lists:[[NSColor]] = []
